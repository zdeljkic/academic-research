...
('community', 'IpToWiki'),
('community', 'BookArticleToPerson'),
('community', 'PhraseToArticleGS'),
('community', 'PhraseToArticleIEEE'),
...
('search_engine', 'PersonToUrlSE'),
('search_engine', 'PhraseToUrlSE'),
('search_engine', 'UrlToEmail'),
('search_engine', 'UrlToUrlInk'),
('search_engine', 'WebsiteToWebsiteInk'),
('academic-research2', 'BookArticleToPerson'),
('academic-research2', 'PhraseToArticleGS'),
('academic-research2', 'PhraseToArticleIEEE'),
...
('IpToIpBlock', 1),
('IpToWiki', 1),
('BookArticleToPerson', 1),
('PhraseToArticleGS', 1),
('PhraseToArticleIEEE', 1),
...
('academic-research1', 'Academic research - step 1'),
('academic-research2', 'Academic research - step 2');
